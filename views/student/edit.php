                        ...
                        <div class="col-xl-6 ">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="room_id" name="room_id">
                                    ...
                                    ?>
                                            <option value="<?php echo $val["id"]; ?>" <?= ($data["student"]["room_id"] == $val["id"]) ? "checked" : " "; ?>><?php echo $val["name"]; ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" name="avatar" alt="1" id="avatar" value="<?= $data["student"]["avatar"]; ?>" accept=".jpg, .png">
